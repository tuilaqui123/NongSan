...
const Category = () => {
    return (
        <div
            ...
            className="w-full h-screen bg-[#e7ede1]  flex flex-col items-center justify-center pb-10"
        >
            <div className="w-11/12 h-full flex flex-col items-center justify-evenly">
                ...
                <div className="w-full grid sm:grid-cols-5 sm:grid-rows-1 grid-cols-3 grid-rows-2 md:gap-5 sm:gap-2 ">
                    <CategoryOption
                        img1={meat}
                        img2={meat_hover}
                        content={"Thịt tươi"}
