...
const CategoryOption = ({ img1, img2, content }) => {
    return (
        <div className="w-full h-auto py-5 flex flex-col items-center cursor-pointer rounded-lg group hover:bg-[#3e3e3e] mt-20 duration-200">
            <div className="w-1/2 relative m-5">
                <img
                    src={img1}
