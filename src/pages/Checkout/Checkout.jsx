    ...
    return (
        <div className="w-full h-auto flex flex-col items-center py-5 mb-20">
            <div className="w-11/12">
                ...
                <div className=" w-full h-auto flex flex-row justify-center items-center border border-gray-300 py-[10vh] rounded-xl shadow-2xl">
                    <div className="w-[95%] h-[90%] flex flex-row gap-10">
                        <div className="w-3/5 h-auto">
                            <p className="text-4xl font-bold mb-10">Thông tin giao hàng</p>
                            <div className="mb-7 flex flex-row gap-5">
                                <button className="bg-[#7dc642] w-1/3 h-[50px] rounded-xl">
                                    <p className="text-white font-medium">Sử dụng thông tin có sẵn</p>
                                </button>
                                <button
                                    className="relative bg-white w-1/3 border border-[#3e3e3e] hover:border-[#7dc642] duration-150 ease-out h-[50px] rounded-xl flex items-center group overflow-hidden group"
                                >
                            ...
                            <div className="w-full mt-10">
                                ...
                                <div className="w-full flex flex-row gap-5">
                                    <div className="w-1/5 p-3 rounded-xl flex flex-col items-center border-2 border-[#7dc642] gap-3 bg-gray-100 cursor-pointer">
                                        <img src="http://nongsan.monamedia.net/template/assets/images/c-form-method-4.png" alt="" />
                                        <p className="text-center">Thanh toán tiền mặt</p>
                                    </div>
                                    <div className="w-1/5 p-3 rounded-xl flex flex-col items-center border gap-3 bg-gray-100 cursor-pointer">
                        ...
                        <div className=" w-2/5 h-auto bg-[#3e3e3e]  flex justify-center items-center rounded-xl p-5">
                            <div className="w-full h-auto flex flex-col items-center  gap-5 border rounded-xl p-4 pb-10">
                                <p className="text-3xl font-bold text-[#7dc642] pb-3 mb-3 border-b border-gray-300">Chi tiết đơn hàng</p>
                                ...
                                <div className="w-full flex flex-col gap-3">
                                    <div className="w-full flex flex-row justify-between items-end text-white">
                                ...
                                <div className="w-full flex flex-row justify-between items-end text-white mt-7">
