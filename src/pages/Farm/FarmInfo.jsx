...
const FarmInfo = ({ isShow, value }) => {
    ...
    return (
        <div
            ...
            className={clsx({
                "w-full h-auto p-5 bg-[#3e3e3e] my-10 duration-200 ease-in rounded-xl flex flex-row gap-5": isShow,
                "hidden": !isShow
            })}
        >
            <div className="w-1/4 h-full bg-white p-5 rounded-xl">
                <div className="w-full h-full">
                    ...
                    <div className="mt-20 flex flex-col gap-5 mb-5">
                        <div
            ...
            <div className="w-3/4 rounded-xl bg-white p-5">
                {content == 2 ? (
                    <div className="w-full h-full flex flex-col gap-5">
                        <p className="text-2xl font-bold text-center">CÁC SẢN PHẨM CỦA <span className="text-[#7dc642] font-black text-4xl">{value.name}</span> </p>
                        <div className="w-full p-3 grid grid-cols-4 scrollable-div overflow-y-scroll gap-5 ">
                    ...
                    <div className="w-full h-full flex flex-col gap-5">
                        <p className="text-2xl font-bold text-center">THÔNG TIN TRANG TRẠI <span className="text-[#7dc642] font-black text-4xl">{value.name}</span> </p>
